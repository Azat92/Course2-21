...
//- (NSArray *)modifyUsingBlock:(id (^)(id element))block;
//@end
//
...
//}
//
//- (NSArray *)selectUsingBlock:(BOOL (^)(id element))block {
//    NSMutableArray *result = [NSMutableArray new];
//    [self enumerateObjectsUsingBlock:^(id obj, NSUInteger idx, BOOL * _Nonnull stop) {
//        if (block(obj))
...
//}
//
//- (id)shrinkUsingInitial:(id)initial andBlock:(id (^)(id current, id element))block {
